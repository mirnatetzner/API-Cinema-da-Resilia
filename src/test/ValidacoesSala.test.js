...
test("Validar se o número de cadeiras namoradeiras é um número inteiro", ()=>{
    expect(ValidacoesSala.validaCadeirasNamoradeiras(6)).toBe(true)
})

test("Validar se o número de cadeiras comuns é um número inteiro", ()=>{
    expect(ValidacoesSala.validaCadeirasComuns(false)).toBe(false)
}) 

test("Validar se o número de espaços disponíveis para acesso de cadeirantes é um número inteiro", ()=>{
    expect(ValidacoesSala.validaEspaçosCadeirantes(5)).toBe(true)
}) 

test("Validar se o número de espaços disponíveis para acesso de cadeirantes é um número inteiro", ()=>{
    expect(ValidacoesSala.validaEspaçosCadeirantes(5/2)).toBe(false)
}) 
...
test("Validar se a sala está com o certificado de vistoria anual em dia ou não", ()=>{
    expect(ValidacoesSala.validaCertificadoDeVistoriaAnual(1)).toBe(true)
}) 
